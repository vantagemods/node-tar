...
var encodePositive = function (num, buf) {
    buf[0] = 0x80;
...
var encodeNegative = function (num, buf) {
    buf[0] = 0xff;
    var flipped = false;
    num = num * -1;
    for (var i = buf.length - 2; i > 0; i--) {
...
var onesComp = function (byte) { return (0xff ^ byte) & 0xff; };
var twosComp = function (byte) { return ((0xff ^ byte) + 1) & 0xff; };
